...
public class ImageStorageTootl {
    ...
    public static String upload(String fileName, String folder, File file) {
        ...
        params.put("folder", Config.getInstance().getString("toolbox.upload.base.folder") + folder);
        ...
        HttpUtility.upload(Config.getInstance().getString("toolbox.uploadUrl") + "upload2.jsp?scerectKey=DSJK164dsaDLD", params, files);
